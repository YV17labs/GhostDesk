//! GhostDesk branding, exposed as MCP `Icon` objects.
//!
//! Mirrors `assets/logo-mark.svg`, inlined so the binary has no runtime
...
/// The mark as a `data:` URI, built once.
...
/// The icon list every tool and resource carries.
